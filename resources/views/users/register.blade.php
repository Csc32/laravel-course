    ...
    <x-card class="max-w-lg mx-auto mt-24">
        ...
        <form method='POST' action="/users">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full dark:text-slate-950" name="name"
                    value="{{ old('name') }}" />
                @error('name')
            ...
            <div class="mb-6">
                ...
                <input type="email" class="border border-gray-200 rounded p-2 w-full dark:text-slate-950"
